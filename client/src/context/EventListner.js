...
const AddNewEvent = (eventFilter, provider, cb) => { //cb here is callback function
...
//we can use websocket for event fetch
export const createEventListeners = ({ navigate, contract, provider, walletAddress, setShowAlert, setUpdateGameData, player2Ref, player1Ref }) => {
