const styles = {
  ...
  // card component
  cardContainer: 'relative sm:w-[260px] w-[220px] sm:h-[265px] h-[280px] z-0 transition-all',
  cardImg: 'w-full h-full object-contain',
  cardPointContainer: 'absolute sm:w-[67px] w-[32px] sm:h-[30px] h-[32px] rounded-[25px] bottom-[31.4%]',
